...
export const ALL_METROS: ActiveMetro[] = [
  ...
  { slug: "south-bay",  displayName: "South Bay LA",       state: "CA", lat: 33.85,   lng: -118.39,   defaultZoom: 12, radiusMiles: 10 },
  ...
  { slug: "lexington",  displayName: "Lexington",          state: "MA", lat: 42.440,  lng: -71.225,   defaultZoom: 12, radiusMiles: 7 },
