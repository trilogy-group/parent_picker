...
export function generateLocationHelpHtml(
  ...
  return `
    ...
    <div style="margin-top:24px;">
      ${helpLink}<a href="https://real-estate.alpha.school/?location=${locationId}&tab=other" style="display:inline-block;padding:12px 24px;background:#2563eb;color:#ffffff;text-decoration:none;border-radius:8px;font-weight:bold;font-size:14px;">Contribute a Comment</a>
    </div>
